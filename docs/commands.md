...
Opens a VS Code-like terminal session in the browser. The shell now starts as direct `bash` for smoother typing, cleaner rendering, and optional manual `tmux` when you want detachable sessions.
